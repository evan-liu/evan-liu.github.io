...
<AgileTimelineItem time="2009" title="Srumban">
  Corey Ladas suggested that Kanban could improve upon Scrum and suggested
  Scrumban as the transition from Scrum to Kanban in his book [Scrumban – Essays
  on Kanban Systems for Lean Software Development](http://amzn.to/2n8OsPq).
</AgileTimelineItem>

<AgileTimelineItem time="2010" title="Kanban">
  David J. Anderson publishes [Kanban: Successful Evolutionary Change for Your
  Technology Business](http://amzn.to/2oAvtNx) as the first description of the
  method.
</AgileTimelineItem>
