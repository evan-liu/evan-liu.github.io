...
Instead of squeezing over 200 shortcuts into combinations of `⌘⌥⌃⇧` modifiers,
...
- [`HJKL` with `⌘⌥⌃⇧` modifiers](/productivity/editor-keymaps/#hjkl-with-modifiers) for jumping/moving up/down and back/forward.
- [Leader Key Mappings](/productivity/editor-keymaps#leader-key-mappings) for one-off actions.
...
[(not yet) same mappings](/productivity/editor-keymaps/)
I have with IDEs.
