...
- Input source. I still need to use [Chinese input](/productivity/mac/squirrel) sometime.
- [RAM usage](/productivity/mac/stats) until I get a Mac with so big RAM that I no longer care.
- [Battery](/productivity/mac/stats) as I often use the Mac off the charger, e.g. in the office.
